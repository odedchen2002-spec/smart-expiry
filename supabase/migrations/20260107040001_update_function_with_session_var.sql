-- Update enforce_plan_limits function to set session variable
-- This allows it to bypass RLS via the policy we created
...
DECLARE
  ...
  v_keep_ids UUID[];
BEGIN
  -- Set session variable to allow policy to pass
  SET LOCAL app.enforce_plan_limits = 'true';
